...
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-2xl font-semibold text-gray-800 dark:text-white">Liste des Types de Documents</h2>
        <a href="{{ route('type_documents.create') }}"
            ...
            <i class="bi bi-plus-lg mr-2"></i> Ajouter Type Document
        </a>
    </div>
            ...
            <tbody class="divide-y divide-gray-100">
                @foreach ($type_documents as $type)
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-900 border-b dark:border-gray-800 dark:text-white">
                        ...
                        <td class="px-6 py-4">{{ $type->TypeDocument }}</td>
                        <td class="px-6 py-4 text-center">
                            <div class="flex justify-center gap-2">
                                {{-- Edit --}}
                                <a href="{{ route('type_documents.edit', $type->id) }}"
