...
<div class="container mx-auto px-4 py-8">
    <h2 class="text-2xl font-bold text-black dark:text-gray-300 mb-6">Ajouter un Type de Document</h2>
    <form action="{{ route('type_documents.store') }}" method="POST" class="space-y-6">
        @csrf
        ...
        <div class="max-w-md">
            ...
            <input type="text" id="TypeDocument" name="TypeDocument"
                value="{{ old('TypeDocument', $type_documents->TypeDocument ?? '') }}"
