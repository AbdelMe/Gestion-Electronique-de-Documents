    ...
    <div class="min-h-screen py-6 px-4 sm:px-6 lg:px-8">
        <div class="max-w-7xl mx-auto">
            <div class="flex flex-col sm:flex-row justify-between items-center mb-6">
                ...
                <a href="{{ route('dossiers.create') }}" class="inline-flex items-center px-4 text-indigo-700 border hover:text-white border-indigo-600 py-2 hover:bg-indigo-700  dark:text-white text-sm font-medium rounded-xl shadow-sm transition-colors duration-200">
                        ...
                        <div class="p-4">
                            <div class="flex items-start">
                                ...
                                <div class="ml-3 flex-1">
                                    <h3 class="text-sm font-medium text-gray-900 leading-tight dark:text-gray-300">{{ $dossier->Dossier }}</h3>
                                    <p class="text-xs text-gray-500 mt-0.5 dark:text-gray-300">{{ $dossier->Annee }}</p>
                                </div>
                            </div>
                            ...
                            <div class="mt-3 flex justify-between items-center pt-2 border-t border-gray-100 dark:border-gray-700">
                                <a href="{{ route('dossiers.show', $dossier->id) }}" class="text-xs font-medium text-blue-600 hover:text-blue-800 transition-colors">
                                    Voir
                                </a>
                                <div class="flex space-x-1">
                                    <a href="{{ route('dossiers.edit', $dossier->id) }}" class="p-1 text-gray-400 hover:text-blue-600 rounded-full hover:bg-blue-50 transition-colors dark:hover:bg-gray-700">
            ...
            <div class="col-span-full py-4 text-center">
                <div class="bg-blue-50 border border-blue-200 text-blue-700 px-4 py-3 rounded-xl dark:text-gray-300 dark:bg-gray-800">
