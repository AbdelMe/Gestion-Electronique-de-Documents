    ...
    <div class="min-h-screen py-6 px-4 sm:px-6 lg:px-8">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-center mb-6">
                ...
                <a href="{{ route('dossiers.create') }}" class="inline-flex items-center px-4 py-2 bg-teal-400 hover:bg-teal-500 text-white text-sm font-medium rounded-md shadow-md">
