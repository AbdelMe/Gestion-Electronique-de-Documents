                                ...
                                <div class="p-4">
                                    <div class="flex items-start">
                                        ...
                                        <div class="ml-3 flex-1">
                                            <h3 class="text-sm font-medium text-gray-900 leading-tight dark:text-gray-300">
                                                {{ $dossier->Dossier }}</h3>
                                            <p class="text-xs text-gray-500 mt-0.5 dark:text-gray-300">{{ $dossier->Annee }}
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div
                                        class="mt-3 flex justify-between items-center pt-2 border-t border-gray-100 dark:border-gray-700">
