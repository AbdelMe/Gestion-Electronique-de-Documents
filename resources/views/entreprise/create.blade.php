...
<div class="container mx-auto px-4 py-8">
    <h2 class="text-2xl font-bold text-gray-700 mb-6">Ajouter une Entreprise</h2>
    ...
    <form action="{{ route('entreprise.store') }}" method="POST" class="space-y-6">
        ...
        <div class="max-w-md">
            ...
            <input type="text" id="NomClient" name="NomClient"
                ...
                class="w-full border-2 border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
            @error('NomClient')
                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
            @enderror
        </div>

        {{-- You can add more fields in same style like this one --}}
