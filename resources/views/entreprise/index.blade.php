        ...
        <table class="min-w-full text-sm text-gray-800">
            <thead>
                <tr class="border-b dark:border-gray-800 dark:text-white">
                    ...
                    <th class="px-6 py-4 text-left font-semibold">Département</th>
            ...
            <tbody class="divide-y divide-gray-100">
                @foreach ($entreprises as $entreprise)
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-900 border-b dark:border-gray-800 dark:text-white ">
                        <td class="px-6 py-4 border-b dark:border-gray-800">{{ $entreprise->id }}</td>
                        <td class="px-6 py-4 border-b dark:border-gray-800">{{ $entreprise->NomClient }}</td>
