                ...
                <div class="p-6">
                    ...
                    <div class="flex flex-wrap gap-4 mb-6">
                        <div class="bg-blue-50 dark:bg-blue-900/30 px-4 py-3 rounded-lg flex-1 min-w-[200px]">
                            <p class="text-sm text-gray-600 dark:text-gray-300">@lang('dashboard.total_size')</p>
                        ...
                        <div class="bg-green-50 dark:bg-green-900/30 px-4 py-3 rounded-lg flex-1 min-w-[200px]">
                            <p class="text-sm text-gray-600 dark:text-gray-300">@lang('dashboard.average_size')</p>
