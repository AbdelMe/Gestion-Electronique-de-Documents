                        ...
                        @foreach ($logs as $log)
                            <tr
                                ...
                                <td class="px-6 py-4 border-b dark:border-gray-800">
                                    ...
                                    @else
                                        <span class="text-red-500">Document deleted</span>
                                    @endif
                                </td>
                                <td class="px-6 py-4 border-b dark:border-gray-800">
                                    {{ \Carbon\Carbon::parse($log->date)->format('D d M, Y') }} </td>
                ...
                <tbody>
                    @foreach ($logs as $log)
                        <tr>
                            ...
                            <td>{{ \Carbon\Carbon::parse($log->date)->format('D d M, Y') }}</td>
                            <td>{{ $log->action }}</td>
                        </tr>
                    @endforeach
                </tbody>
