...
@section('content')
    <div class="container mx-auto px-6 py-8">
        <div class="max-w-4xl mx-auto bg-white rounded-xl shadow p-8 dark:bg-gray-900">
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            @error('entreprise_id') <div class="text-red-500 text-sm">{{ $message }}</div> @enderror
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="file" name="profile_image"
                            class="w-full border-2 border-gray-300 rounded-md px-4 py-2 dark:bg-gray-800 dark:border-gray-700">
                        @error('profile_image') <div class="text-red-500 text-sm">{{ $message }}</div> @enderror
                    </div>

                    <div class="text-center">
                        <button type="submit"
                            class="px-6 py-2 bg-blue-600 text-white font-semibold rounded-xl hover:bg-blue-700 focus:ring-2 focus:ring-blue-400">
                            Créer l'utilisateur
                        </button>
                    </div>
                </div>
