<div class="container mx-auto px-4 py-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        ...
        @forelse($documents as $document)
            @if (
                $document->Etat->etat == 'Approved' &&
                    (Auth::user()->hasRole('super admin') || $document->Dossier->entreprise->id == Auth::user()->entreprise_id))
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="flex space-x-1">
                            ...
                            <x-confirm-button message='Êtes-vous sûr de vouloir supprimer ce Document ?'
