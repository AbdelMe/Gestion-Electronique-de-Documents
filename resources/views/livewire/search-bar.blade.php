<div>
    <div class="mt-3">
        <input type="text" class="form-control mb-3 text-light" placeholder="Search document" wire:model.live='search_doc' style="width: 400px">
        <div id="SearchResults" class="position-absolute shadow rounded" style="max-height: 500px; overflow-y: auto; overflow-x: hidden; scrollbar-width: none; -ms-overflow-style: none; width: fit-content;background-color: #232936ea">
                ...
                <tbody>
                    ...
                    <tr style="color: white">
                        ...
                        <td class="text-nowrap">
                            <a href="{{ asset('storage/'.$doc->DocumentNumerique) }}" 
                               target="_blank"
