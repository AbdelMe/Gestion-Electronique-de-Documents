    ...
    <div class="mt-3 relative">
        ...
        @if (!empty($docs))
            <div id="SearchResults"
                class="absolute z-50 mt-2 w-full max-w-[430px] bg-white dark:bg-gray-800 text-gray-800 dark:text-white rounded-lg shadow-lg max-h-96 overflow-y-auto scrollbar-none">
                <table class="w-full table-auto border-collapse text-sm">
                    <thead>
                        <tr class="bg-gray-100 dark:bg-gray-900">
                            <th class="text-nowrap px-4 py-2 text-left font-medium text-gray-700 dark:text-gray-300">Type Doc</th>
                            <th class="text-nowrap px-4 py-2 text-left font-medium text-gray-700 dark:text-gray-300">Dossier</th>
                            <th class="text-nowrap px-4 py-2 text-left font-medium text-gray-700 dark:text-gray-300">Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach ($docs as $doc)
                            <tr class="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                                ...
                                <td class="text-nowrap px-4 py-2">
                                    <a href="{{ route('documents.show', $doc->id) }}"
                                       class="inline-flex items-center px-3 py-1 text-xs font-medium text-green-700 bg-green-100 border border-green-300 rounded-full hover:bg-green-200 dark:text-green-300 dark:bg-green-900/50 dark:border-green-700 dark:hover:bg-green-900">
