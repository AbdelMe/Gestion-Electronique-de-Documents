        ...
        <div class="row mb-4">
            <div class="col-md-6">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control bg-dark text-white" placeholder="Rechercher un document...">
                </div>
            </div>
            <div class="col-md-3">
                <select class="form-select form-control bg-dark text-white">
            ...
            {{-- <div class="col-md-3">
                <select class="form-select bg-dark text-white">
                    <option selected>Filtrer par dossier</option>
                    @foreach($dossiers as $dossier)
                        <option value="{{ $dossier->id }}">{{ $dossier->Dossier }}</option>
                    @endforeach
                </select>
            </div> --}}
        </div>
            ...
            @foreach ($documents as $document)
                <div class="col-md-6 col-lg-4 mt-2">
                    <div class="card document-card h-100">
                        <div class="card-header text-white d-flex justify-content-between align-items-center" style="background: linear-gradient(90deg, #496683 0%, #131d27 100%);">
                        ...
                        <div class="card-body">
                            ...
                            <div class="document-info">
                                ...
                                {{-- <div>
                                    ...
                                    <small class="text-muted">{{ $document->CheminDocument }}</small>
                                </div> --}}
                            </div>
                        </div>
