...
<div class="container mx-auto px-4 py-8 pt-2">
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-2xl font-semibold text-gray-800 dark:text-white">Assign Permissions to Role</h2>
    </div>

    <div class="bg-white dark:bg-transparent rounded-lg p-6">
        <form method="POST" action="{{ route('user_permissions.storeAssignPermitionsToRole') }}">
            @csrf
