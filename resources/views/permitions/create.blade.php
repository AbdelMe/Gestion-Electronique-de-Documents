...
<div class="container mt-3">
    ...
    <form action="{{ route('permitions.store') }}" method="POST" class="p-4">
        @csrf

        <div class="mb-3">
            <label for="name" class="form-label fw-medium text-dark">Nom de la Permission</label>
            <input type="text" class="form-control border-2" id="name" name="name" placeholder="Ex: Créer des articles" required>
        </div>

        <div class="mb-4 col-md-6 p-0">
            <label for="user_id" class="form-label fw-medium text-dark">Utilisateur</label>
