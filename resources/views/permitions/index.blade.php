...
@section('content')
    <div class="container mt-1">
        <h2 class="mb-4 text-dark">Liste des Permitions</h2>
        <a href={{ route('permitions.create') }} class="btn btn-success mb-3"><i class="bi bi-plus-lg"></i> Ajouter
            Permitions</a>
        <table class="table text-light">
            <thead style="background: linear-gradient(90deg, #131d27 0%, #496683 100%)">
                <tr>
                    ...
                    <th class="text-light">Permition</th>
